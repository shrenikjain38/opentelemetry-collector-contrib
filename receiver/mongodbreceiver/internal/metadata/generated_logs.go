...
func (e *eventDbServerQuerySample) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue string, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, userNameAttributeValue string, mongodbApplicationNameAttributeValue string, mongodbOperationIDAttributeValue string, mongodbQuerySignatureAttributeValue string, mongodbOperationDurationAttributeValue float64) {
	if !e.config.Enabled {
		return
	}
...
func (lb *LogsBuilder) RecordDbServerQuerySampleEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue AttributeDbSystemName, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, userNameAttributeValue string, mongodbApplicationNameAttributeValue string, mongodbOperationIDAttributeValue string, mongodbQuerySignatureAttributeValue string, mongodbOperationDurationAttributeValue float64) {
	lb.eventDbServerQuerySample.recordEvent(ctx, timestamp, clientAddressAttributeValue, clientPortAttributeValue, dbSystemNameAttributeValue.String(), dbNamespaceAttributeValue, dbCollectionNameAttributeValue, dbOperationNameAttributeValue, dbQueryTextAttributeValue, userNameAttributeValue, mongodbApplicationNameAttributeValue, mongodbOperationIDAttributeValue, mongodbQuerySignatureAttributeValue, mongodbOperationDurationAttributeValue)
}
